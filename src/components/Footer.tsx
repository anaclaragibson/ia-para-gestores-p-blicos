...
const Footer = () => {
  return (
    <footer>
      {/* CTA section with gradient background like reference */}
      <div className="bg-gradient-to-r from-[hsl(187_90%_42%)] to-[hsl(263_84%_58%)] py-20 px-4 text-white text-center">
        <div className="container max-w-3xl space-y-6">
          ...
          >
            Leve capacitação clara, atual e aplicável sobre Inteligência Artificial para sua equipe
          </motion.p>
          ...
          >
            <a
              href="#lista-espera"
              className="inline-flex items-center gap-2 bg-white text-[hsl(263_84%_58%)] font-semibold px-7 py-3.5 rounded-lg hover:bg-white/90 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 border-2 border-white/80 text-white font-semibold px-7 py-3.5 rounded-lg hover:bg-white/10 transition-colors"
            >
          ...
          >
            <div className="flex flex-col items-center gap-3 mb-4">
              <img src={logo} alt="Insights Políticos & Empresariais" className="w-14 rounded-lg bg-white p-1.5" />
            </div>
      ...
      {/* Copyright bar */}
      <div className="bg-[hsl(263_84%_48%)] py-4 px-4 text-center">
